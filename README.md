# PAAudioIC
PAAudioIC provides tools for calculating the *information content* (IC) as a proxy for human-perceived surprise when listening to music.  This repo is the official implementation of [*"Perceptually Aligning Representations of Music via Noise-Augmented Autoencoders"*, Bjare et al., Neurips 2025 - AI for Music Workshop](https://openreview.net/forum?id=rXUKO0ysUy).
